...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkoutPage.enterBillingDetailsFirstName("Narendra");
        checkoutPage.enterBillingDetailsLastName("Modi");
        checkoutPage.enterBillingDetailsEmail("Modi" + getRandomAlphaNumericString(4) + "@gmail.com");
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsTelephone("07654321234");
        checkoutPage.enterBillingDetailsAddress("10 Pinner Road");
        checkoutPage.enterBillingDetailsCity("Harrow");
        checkoutPage.enterBillingDetailsPostcode("HA41SY");
